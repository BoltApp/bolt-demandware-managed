...
var initializeButton = function (checkoutBoltButton) {
    // repeat until Bolt button is created
    var boltButtonExist = setInterval(function () {
        if (checkoutBoltButton.length > 0 && window.BoltCheckout && checkoutBoltButton.children()[0].nodeName === 'svg') {
            ...
            checkoutBoltButton.children().replaceWith(checkoutBoltButton.children().clone());
...
module.exports = initializeButton;
